...
public class RegistryLoader {
     ...
     * 动态加载的类列表
     */
    private static final List<Class<?>> LOAD_CLASS_LIST = Arrays.asList(Registry.class);
    ...
    public static <T> T getInstance(Class<T> tClass,String key){
        ...
        if (!instanceCache.containsKey(implClassName)){
            try {
                instanceCache.put(implClassName,implClass.newInstance()); //后面这个是类生成一个新的对象
